...
//Abaixo, logo na declaração dos parâmetros da função, será atribuído um valor padrão apenas ao parâmetro "b", fazendo com que não exista obrigatoriedade para atribuir um valor a ele.
function sub(a,b = 80) {
    console.log(a - b)
